...
Do a "mvn clean install" on this project
Run similar to following command from the directory that you want to create the new project in:

mvn archetype:create -DarchetypeGroupId=org.tohu -DarchetypeArtifactId=tohu-archetype -DarchetypeVersion=1.6.2-SNAPSHOT -DgroupId=com.mycompany -DartifactId=TestProject
