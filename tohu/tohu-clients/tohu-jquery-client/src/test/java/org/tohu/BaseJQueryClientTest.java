...
public abstract class BaseJQueryClientTest extends AbstractSeleniumTest {
	...
	public void testDynamicPage() throws Exception {
		...
		try {
			...
			//debug("JQueryClientTest.testDynamicPage() item_2_2 Answer=" + getTextAnswer("item_2_2"));
			//debug("JQueryClientTest.testDynamicPage() item_4_1 Answer=" + getCheckboxAnswer("item_4_1"));
			//debug("JQueryClientTest.testDynamicPage() item_2_3 Answer=" + getRadioButtonAnswer("item_2_3"));
			//debug("JQueryClientTest.testDynamicPage() item_3_1 Answer=" + getDropDownAnswer("item_3_1"));
		}
		catch (Exception ex) {
	...
	// Selenium doesn't support determining where the focus is.
	//@org.junit.Test
	//public void testTabOrder() throws Exception {
	//	debug("JQueryClientTest.testTabOrder()");
	//	try {
	//		// Test the tabbing order is correct.
	//		// Both directions.
	//		// Add & remove fields.
	//	}
	//	catch (Exception ex) {
